...
#define IOT_DEVICE_ID      "6a83ca9fcbb0cf6bb97a57b0_shebei"   /* 设备ID(提取自旧版 mqtt.h, 可用) */
#define IOT_DEVICE_SECRET  "09e2d555d80a8354c31e2973883199fdb5ad276ee9c4220e6c21397f5ea641c1"  /* 设备密钥 */
/* clientId = {device_id}_0_0, username = device_id, password = device_secret
 * (时间戳填0时 password 直接填密钥, ESP8266 无法算 HMAC, 必须用此方式)
 * 旧版 mqtt.h 的 clientId 是 {device_id}_0_0_2026081803, 同为时间戳=0 密钥直连, 等效 */
